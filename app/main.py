...
async def lifespan(app: FastAPI):
    ...
    if env.openrouter_model and env.openrouter_model != global_settings.openrouter_model:
        updates["openrouter_model"] = env.openrouter_model
    if env.draw_model and env.draw_model != getattr(global_settings, "draw_model", ""):
